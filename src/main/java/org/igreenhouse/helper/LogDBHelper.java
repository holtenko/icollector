...
public class LogDBHelper {
    private static final Logger LOGGER = LoggerFactory.getLogger(LogDBHelper.class);
    ...
    static {
        ...
        DATA_SOURCE.setUrl(DBconf.logdb_url);
    ...
    public static <T> boolean updateEntity(Class<T> entityClass, int id, Map<String, Object> fieldMap) {
        ...
        sql += columns.substring(0, columns.lastIndexOf(", ")) + " WHERE uid=?";
